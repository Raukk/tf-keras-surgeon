...
# the first layer is a seperable conv
first_layer = layers.Conv2D(4, (7, 1), strides=(3,3), name='first_conv_7x1')(input_placeholder)
first_layer = layers.Conv2D(4, (1, 7), strides=(3,3), name='first_conv_1x7')(first_layer)
#first_layer = InverseActivation(name='first_inv_activ')(first_layer)# Maybe?
first_layer = layers.Conv2D(16, (1, 1), strides=(1,1), name='first_conv_1x1')(first_layer)
first_layer = InverseActivation(name='first_inv_activ')(first_layer)
# The output has 32 filters, because it doubles the values of the previous
# result is 8x8x32 
